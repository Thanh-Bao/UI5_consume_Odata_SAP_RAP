		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ZABCDEMO1project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ZABCDEMO1project1-display": {
								"semanticObject": "ZABCDEMO1project1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZABCDEMO1.project1",
									"url": sap.ui.require.toUrl("ZABCDEMO1/project1")
								}
							}
						}
					}
